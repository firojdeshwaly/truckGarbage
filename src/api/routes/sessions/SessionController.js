const {
  models: { User, Booking, Review, LikeDislike, TrainerSession, Notification, Card, Payment, Customer, Division, Group, JoinGroup, Bank, Chat, Filter, Sport }
} = require('../../../../app/models');
...
class SessionController {
  ...
  async TrainersList(req, res, next) {
    ...
    try {
      ...
      let SPORT = await Sport.findOne({ _id: sport }).lean();
      let QUERY = {};
      if (SPORT) {
        QUERY = {
          SPORT: { $eq: SPORT.name }
